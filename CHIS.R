...
# Please replace the file pathway below with the file pathway to where your ADULT.sav file is stored.
adult <- read.spss("Documents/Springboard Files/Exploratory Data Analysis/chis09_adult_spss/chis09_adult_spss/ADULT.sav", to.data.frame = TRUE)
...
# BMI histogram
adult$BMI_P <- as.numeric(as.character(adult$BMI_P))
